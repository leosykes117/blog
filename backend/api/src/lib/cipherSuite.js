/**
 * @module Components/cipherSuite
 * @description - Módulo encargado de los algoritmos de criptográficos.
 * <pre>
 * MÓDULOS NECESARIOS PURE JAVASCRIPT
 * --------------------------------------------------
 * 1. node-forge
 * --------------------------------------------------
 * </pre>
...
var cipherSuite = {
	 ...
	 * @name module:Components/cipherSuite#createRandomBytes
	 * @public
	 ...
	 * @name module:Components/cipherSuite#stringToBase64
	 * @public 
	 ...
	 * @name module:Components/cipherSuite#encodeBase64
	 * @public 
	 ...
	 * @name module:Components/cipherSuite#base64ToString
	 * @public 
	...
	/**
	 * @function hash
	 * @name module:Components/cipherSuite#hash
	 * @public 
	 ...
	 * @name module:Components/cipherSuite#createAESKeyFromString
	 * @public 
	 ...
	 * @name module:Components/cipherSuite#hexToString
	 * @public 
	 ...
	 * @name  module:Components/cipherSuite#aesEncryptResult
	...
	/**
	 * @function aesEncrypt
	 * @name  module:Components/cipherSuite#aesEncrypt
	 * @public 
	 ...
	 * @returns {aesEncryptResult}  - Descripción de resultado de cifrado.  {@link module:Components/cipherSuite#aesEncryptResult} 
	 */
	 ...
	 * @name  module:Components/cipherSuite#aesDecryptResult
	...
	/**
	 * @function aesDecrypt
	 * @name  module:Components/cipherSuite#aesDecrypt
	 * @public 
	 ...
	 * @returns {aesDecryptResult} - Resultado del descifrado. {@link module:Components/cipherSuite#aesDecryptResult} 
	 */
	 ...
	 * @name  module:Components/cipherSuite#getBase64EncodedFromBuffer
	 * @private 
	 ...
	 * @name  module:Components/cipherSuite#getForgeObjectFromCer
	 * @private 
	 ...
	 * @name  module:Components/cipherSuite#getForgePrivateKeyFromKey
	 * @private 
	 ...
	 * @name  module:Components/cipherSuite#rsaEncryptResult
	 * @property {Number} code - En caso de que el cifrado se realice de manera correcta se regresa 1,  en caso de que exista algún error  -1.
	 * @property {String} message - Descripción del resultado. (IMPRIMIBLE)
	 * @property {Object} data 
	 * @property {String} data.encryptedText - Texto cifrado.
	...
	/**
	 * @function rsaEncrypt
	 * @name  module:Components/cipherSuite#rsaEncrypt
	 * @public 
	 ...
	 *certificate = utilities.base64EncodeFromNativeBinary(certificate)
	 *</pre>
	 * @returns {rsaEncryptResult} - Resultado del cifrado. {@link module:Components/cipherSuite#rsaEncryptResult} 
	 */
	 ...
	 * @name module:Components/cipherSuite#rsaDecryptResult
	 * @property {Number} code - En caso de que el descifrado se realice de manera correcta se regresa 1,  en caso de que exista algún error  -1.
	 * @property {String} message - Descripción del resultado. (IMPRIMIBLE)
	 * @property {Object} data 
	 * @property {String} data.plainText - Texto descifrado.
	...
	/**
	 * @function rsaDecrypt
	 * @name module:Components/cipherSuite#rsaDecrypt
	 * @public 
	 ...
	 * @returns {rsaDecryptResult} - Resultado del descifrado. {@link module:Components/cipherSuite#rsaDecryptResult} 
	 */
	 ...
	 * @name  module:Components/cipherSuite#rsaSignResult
	...
	/**
	 * @function rsaSign
	 * @name module:Components/cipherSuite#rsaSign
	 * @public 
	 ...
	 * </pre>
	 * @param {String} passwordKey - Clave para descifrar llave privada.
	 * @returns {rsaSignResult} - Resultado de la firma. {@link module:Components/cipherSuite#rsaSignResult}
	 */
	 ...
	 * @name  module:Components/cipherSuite#rsaVerifySignatureResult
	 ...
	 *certificate = utilities.base64EncodeFromNativeBinary(certificate)
	 *</pre>
	 * @returns {rsaVerifySignatureResult} - Resultado de la firma. {@link module:Components/cipherSuite#rsaVerifySignatureResult}
	 */
	 ...
	 * @name  module:Components/cipherSuite#rsaSignHashResult
	 * @property {Number} code - En caso de que el firmado se realice de manera correcta se regresa 1,  en caso de que exista algún error  -1.
	 * @property {String} message - Descripción del resultado. (IMPRIMIBLE)
	 * @property {Object} data 
	 * @property {String} data.signature - Firma.
	 ...
	 * @name  module:Components/cipherSuite#rsaSignHash
	 * @public 
	 ...
	 * </pre>
	 * @param {String} passwordKey - Clave para descifrar llave privada.
	 * @returns {rsaSignHashResult} - Resultado de la firma. {@link module:Components/cipherSuite#rsaSignHashResult}
	 */
	 ...
	 * @name  module:Components/cipherSuite#rsaVerifySignatureHashResult
	 ...
	 * @name  module:Components/cipherSuite#rsaVerifySignatureHash
	 * @public 
	 ...
	 *certificate = utilities.base64EncodeFromNativeBinary(certificate)
	 *</pre>
	 * @returns {rsaVerifySignatureHashResult} - Resultado de la firma. {@link module:Components/cipherSuite#rsaVerifySignatureHashResult}
	 */
	 ...
	 * @name  module:Components/cipherSuite#validatePemFormat
	 * @public 
	 ...
	 * @name  module:Components/cipherSuite#calculateEtagMultipart
	 * @public 
	...
	calculateEtag: function (file, blockSize) {
		...
		if (!blockSize) {
			...
			result.data.MD5 = cipherSuite.hashMD5(file.toString("binary"))
			return result
		}
...
exports.validatePemFormat = cipherSuite.validatePemFormat
exports.stringToBase64 = cipherSuite.stringToBase64
exports.encodeBase64 = cipherSuite.encodeBase64
exports.base64ToString = cipherSuite.base64ToString
exports.hash = cipherSuite.hash
exports.createRandomBytes = cipherSuite.createRandomBytes
exports.hexToString = cipherSuite.hexToString
exports.getBase64EncodedFromBuffer = cipherSuite.getBase64EncodedFromBuffer
exports.aesEncrypt = cipherSuite.aesEncrypt
exports.aesDecrypt = cipherSuite.aesDecrypt
exports.rsaEncrypt = cipherSuite.rsaEncrypt
exports.rsaDecrypt = cipherSuite.rsaDecrypt
exports.rsaSign = cipherSuite.rsaSign
exports.rsaSignHash = cipherSuite.rsaSignHash
exports.rsaVerifySignature = cipherSuite.rsaVerifySignature
exports.rsaVerifySignatureHash = cipherSuite.rsaVerifySignatureHash
exports.createAESKeyFromString = cipherSuite.createAESKeyFromString
exports.calculateEtag = cipherSuite.calculateEtag